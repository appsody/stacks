...
This stack is based on the `Quarkus 1.2.0.Final` runtime. It allows you to develop new or existing Java applications that run on Quarkus and can be turned into a native executable for a low memory footprint and near instantaneous (< 10ms) start times.
...
```bash
2019-07-16 12:43:21,918 INFO  [io.quarkus] (main) Quarkus 1.2.0.Final started in 0.006s. Listening on: http://0.0.0.0:8080
